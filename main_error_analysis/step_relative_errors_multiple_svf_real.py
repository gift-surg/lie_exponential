...
if __name__ == "__main__":
    ...
    if compute:  # or compute or load
        ...
        if save_for_sharing:
            ...
            with open(os.path.join(path_to_sharing_folder, 'step_relative_errors_transformation_parameters_real' + file_suffix), 'wb') as f:
                pickle.dump(parameters, f)

            with open(os.path.join(path_to_sharing_folder, 'step_relative_errors_method_tables_real' + file_suffix), 'wb') as f:
                pickle.dump(methods, f)
