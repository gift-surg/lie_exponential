...
if __name__ == "__main__":
    ...
    if compute:  # or compute or load
        ...
        for stp in range(3, max_steps):
            ...
            if verbose:
                ...
                print 'Step-error for each method computed at ' + str(stp) + 'th. step.'
                print '---------------------------------------------'
                print tabulate(results_by_column,
                               headers=['method', 'error'])
                print '---------------------------------------------'

        parameters = [x_1, y_1, z_1] + hom_attributes + [max_steps, ]
    ...
    if verbose:
        ...
        print 'scale factor = ' + str(parameters[4])
        print 'sigma = ' + str(parameters[5])
        print 'in psl = ' + str(parameters[6])
        print 'number of samples = ' + str(parameters[7])

        print 'Step-wise error for one HOM generated SVF'
