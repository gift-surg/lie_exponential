...
from path_manager import pfo_results, pfo_notes_figures, pfo_notes_tables, displacements_aei_fp
...
if __name__ == "__main__":
    ...
    pfi_array_errors_output = os.path.join(pfo_errors_times_results,
                                                fin_array_errors_output + file_suffix + '.npy')
    pfi_array_comp_time_output = os.path.join(pfo_errors_times_results,
                                                   fin_array_comp_time_output + file_suffix + '.npy')
    pfi_field = os.path.join(pfo_errors_times_results,
                                  fin_field + file_suffix + '.npy')
    pfi_transformation_parameters = os.path.join(pfo_errors_times_results,
                                                      fin_transformation_parameters + file_suffix + '.npy')
    pfi_numerical_method_table = os.path.join(pfo_errors_times_results,
                                                   fin_numerical_methods_table + file_suffix)

    # path to results external to the project:
    pfi_figure_output  = os.path.join(path_to_exp_notes_figures,
                                           fin_figure_output + file_suffix + '.pdf')
    pfi_csv_table_errors_output = os.path.join(path_to_exp_notes_tables,
                                                    fin_csv_table_errors_output + '.csv')
    pfi_csv_table_comp_time_output = os.path.join(path_to_exp_notes_tables,
                                                       fin_csv_table_comp_time_output + '.csv')
