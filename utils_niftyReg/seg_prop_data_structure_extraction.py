...
from path_manager import full_path_roi_indexes, full_path_means_dice_no_aei, full_path_means_dice_aei, \
    full_path_labelled_dice_no_aei, full_path_labelled_dice_aei, path_to_copy_for_numpy_no_aei, path_to_copy_for_numpy_aei
