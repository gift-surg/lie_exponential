...
from path_manager import path_to_txt_original_data_no_aei, path_to_copy_elaborated_data_step_1_no_aei, \
    path_to_copy_elaborated_data_step_1_aei, path_to_txt_original_data_aei
