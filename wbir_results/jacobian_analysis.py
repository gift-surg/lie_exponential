...
from path_manager import pfo_results, pfo_notes_figures, pfo_notes_tables, pfo_notes_sharing, displacements_aei_fp
...
if __name__ == "__main__":
    ...
    if compute:  # or compute or load
        ...
        if save_for_sharing:
            ...
            np.save(os.path.join(pfo_notes_sharing, 'exp_jacobian_det_matrix_real'), jacobians)

            with open(os.path.join(pfo_notes_sharing, 'exp_jacobian_det_parameters_real'), 'wb') as f:
                pickle.dump(parameters, f)

            with open(os.path.join(pfo_notes_sharing, 'exp_jacobian_det_methods_table_real'), 'wb') as f:
                pickle.dump(methods, f)
